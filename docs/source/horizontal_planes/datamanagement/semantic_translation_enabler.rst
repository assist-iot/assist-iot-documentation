...
.. |Overview of translation with central modularized ontology| figure:: semantic_translation_enabler/uploads/platforms.png
.. |Process overview| figure:: semantic_translation_enabler/uploads/process.png
...
.. |Architecture| figure:: semantic_translation_enabler/uploads/architecture.png
...
.. |GOIoTP and GOIoTPex modules| figure:: semantic_translation_enabler/uploads/giotp.png
...
|                       | incoming RDF data     |                       |
+-----------------------+-----------------------+-----------------------+
| **inpAlignmentVersion | Version of the input  | string                |
| **                    | alignment, used for   |                       |
...
|                       | outgoing RDF data     |                       |
+-----------------------+-----------------------+-----------------------+
| **outAlignmentVersion | Version of the output | string                |
| **                    | alignment, used for   |                       |
| \ *required*          | translating the       |                       |
|                       | outgoing RDF data     |                       |
+-----------------------+-----------------------+-----------------------+
...
Semantic Translation Enabler can be used as a standalone tool, offering
translation via a REST interface. Streaming translation support, for
both MQTT and Kafka message brokers, can be
`configured <Deployment/Configuration.md>`__ via suitable config
